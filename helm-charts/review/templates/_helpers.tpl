{{/*
review helpers - local + ecom-common fallback
*/}}
...
app.kubernetes.io/name: {{ include "review.fullname" . }}
...
{{- define "review.probes.readiness" -}}
httpGet:
...
{{- define "review.topologySpreadConstraints" -}}
...
- maxSkew: 1
  ...
  labelSelector:
    matchLabels:
      {{- include "review.selectorLabels" . | nindent 6 }}
- maxSkew: 1
