{{/*
product helpers - local + ecom-common fallback
*/}}
...
app.kubernetes.io/name: {{ include "product.fullname" . }}
...
{{- define "product.probes.readiness" -}}
httpGet:
...
{{- define "product.probes.liveness" -}}
httpGet:
...
{{- define "product.topologySpreadConstraints" -}}
