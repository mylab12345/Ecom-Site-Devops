{{/*
payment helpers - local + ecom-common fallback
*/}}
...
app.kubernetes.io/name: {{ include "payment.fullname" . }}
...
{{- define "payment.probes.readiness" -}}
httpGet:
...
{{- define "payment.probes.liveness" -}}
httpGet:
...
{{- define "payment.topologySpreadConstraints" -}}
